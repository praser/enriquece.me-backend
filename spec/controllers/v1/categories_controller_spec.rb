  ...
  describe 'PUT #update' do
    ...
    context 'with valid params' do
      let(:update_params) do
        FactoryGirl.attributes_for(:category, id: category.id)
      end
    ...
    context 'with invalid params' do
      let(:update_params) do
        FactoryGirl.attributes_for(:category, id: category.id, name: nil)
      end
    ...
    context 'anothers user category' do
      let(:another_user_category) { FactoryGirl.create(:category) }
      let(:update_params) do
        FactoryGirl.attributes_for(:category, id: another_user_category.id)
      end
